...
docker-images/aarch64.tar: Dockerfile docker_entrypoint.sh scripts/*.sh configurator/target/aarch64-unknown-linux-musl/release/configurator
...
docker-images/x86_64.tar: Dockerfile docker_entrypoint.sh scripts/*.sh configurator/target/x86_64-unknown-linux-musl/release/configurator
	mkdir -p docker-images
